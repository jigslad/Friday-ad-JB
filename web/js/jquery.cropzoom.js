        ...
        return this
            .each(function () {
                ...
                if (!$.isFunction($.fn.draggable)
                    ...
                    alert("You must include ui.draggable and ui.slider to use cropZoom");
                    return;
                }
                ...
                $image.attr('id', 'profile_crop_image');
                        ...
                        .slider({
                            ...
                            slide: function (event, ui) {
                                var value = ($options.expose.slidersOrientation == 'vertical' ? ($options.image.maxZoom - ui.value)
                                    : ui.value);
                                if ($options.image.minZoom + 5 >= value) {
                                    $( "#crop_container_selector" ).draggable( "option", "containment", $('#profile_crop_image'));
                                } else {
                                	$( "#crop_container_selector" ).draggable( "option", "containment", 'parent');
                                }
