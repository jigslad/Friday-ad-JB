...
namespace Fa\Bundle\CoreBundle\lib\Carweb\Validator;

/**
 * Fa\Bundle\CoreBundle\lib\Carweb\Exception
...
class VRM
{
    ...
    public function validateVehicle1982($input)
    {
        ...
        if ($year > 8) {
            $year--; // as there is no I in the scheme
        }

        if ($year > 13) {
            $year--; // as there is no O in the scheme
        }

        if ($year > 15) {
            $year--; // as there is no Q in the scheme
        }
