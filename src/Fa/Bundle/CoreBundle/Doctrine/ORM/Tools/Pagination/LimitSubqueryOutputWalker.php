...
use Doctrine\ORM\Tools\Pagination\LimitSubqueryOutputWalker as BaseLimitSubqueryOutputWalker;
 ...
 */
class LimitSubqueryOutputWalker extends BaseLimitSubqueryOutputWalker
{
    /**
