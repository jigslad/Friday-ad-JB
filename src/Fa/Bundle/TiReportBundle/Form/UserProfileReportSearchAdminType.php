 ...
 * @version v1.0
 */
class UserProfileReportSearchAdminType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('rus_profile_image', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Profile image'))))
            ->add('rus_banner_image', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Banner image'))))
            ->add('rus_welcome_message', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Welcome message'))))
            ->add('rus_address', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Address'))))
            ->add('rus_phone', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Phone'))))
            ->add('rus_website_link', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('Website link'))))
            ->add('rus_about', ChoiceType::class, array('choices' => array_flip($this->getYesNoOptions('About'))))
            ->add(
                'rus_user_type',
                EntityType::class,
                array(
            ...
            ->add(
                ...
                ChoiceType::class,
                array(
                    'choices'  => array_flip(CommonManager::getUserProfileReportFieldsChoices()),
                    'expanded' => true,
                    'multiple' => true,
                    'mapped'   => false
                )
     ...
     */
    public function getYesNoOptions($firstOption)
    {
        return array('' => $firstOption, '1' => 'Yes', '0' => 'No');
    }
    ...
    {
        return 'fa_ti_report_user_profile_report_search_admin';
    }
