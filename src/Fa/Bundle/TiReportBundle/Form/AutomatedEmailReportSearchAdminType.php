...
/**
 * This is automated email report admin search form.
 *
 * @author Amit Limbadia <amitl@aspl.in>
 * @copyright  2014 Friday Media Group Ltd
 * @version v1.0
 */
class AutomatedEmailReportSearchAdminType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                ...
                ChoiceType::class,
                array(
                    'choices' => array_flip($this->em->getRepository('FaEmailBundle:EmailTemplate')->getAllEmailTemplateIdentifierArray()),
                    'placeholder' => 'All automated emails'
                )
            )
    ...
    {
        return 'fa_ti_report_automated_email_search_admin';
    }
