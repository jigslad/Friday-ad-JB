...
EOF
    ...
    protected function automatedEmailReportExportToCsv($searchParam, $input, $output)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->get('kernel')->getRootDir().'/console fa:ti:automated-email:report:export-to-csv '.$commandOptions;
