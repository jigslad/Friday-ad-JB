 ...
 * @version 1.0
 */
class TiAutomatedEmailReportExportToCsvCommand extends ContainerAwareCommand
{
    /**
    ...
    {
        $this
        ->setName('fa:ti:automated-email:report:export-to-csv')
...
Command:
 - php app/console fa:ti:automated-email:report:export-to-csv --criteria='a:2:{s:6:"search";a:3:{s:9:"from_date";s:10:"21/12/2015";s:7:"to_date";s:10:"21/12/2015";s:6:"parsed";s:1:"1";}s:4:"sort";a:2:{s:10:"sort_field";s:32:"automated_email_report_daily__id";s:8:"sort_ord";s:4:"desc";}}'
EOF
        );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (isset($offset)) {
            ...
            $automatedEmailReportDailyRepository = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:AutomatedEmailReportDaily');
            ...
            if (isset($searchParam['search']['csv_name']) && $searchParam['search']['csv_name']) {
                ...
                $fileName = "TiAutomatedEmailReport_".date('d-m-Y H:i:s').'.tmp';
            }
    ...
    protected function automatedEmailReportExportToCsv($searchParam, $input, $output)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->getParameter('project_path').'/console fa:ti:automated-email:report:export-to-csv '.$commandOptions;
        ...
        if (isset($searchParam['search']['csv_email']) && $searchParam['search']['csv_email']) {
            ...
            ->setBody(
                $this->getContainer()->get('templating')->render(
                    'FaTiReportBundle:AutomatedEmailReportAdmin:email.html.twig',
    ...
    {
        $qb = CommonManager::getTiHistoryRepository($this->getContainer(), 'FaTiReportBundle:AutomatedEmailReportDaily')->getAutomatedEmailReportQuery($searchParam['search'], $searchParam['sort'], $this->getContainer(), true);
