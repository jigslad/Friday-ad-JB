 ...
 * @version 1.0
 */
class ExportTiAdEnquiryReportCommand extends ContainerAwareCommand
{
    /**
    ...
    {
        $this
        ->setName('fa:ti:export-ad-enquiry-report')
...
Command:
 - php app/console fa:ti:export-ad-enquiry-report --criteria='a:2:{s:6:"search";a:3:{s:9:"from_date";s:10:"01/06/2015";s:7:"to_date";s:10:"15/06/2015";s:14:"report_columns";a:2:{i:0;s:2:"id";i:1;s:5:"ad_id";}}s:4:"sort";a:2:{s:10:"sort_field";s:19:"ad_report_daily__id";s:8:"sort_ord";s:4:"desc";}}'
EOF
        );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (isset($offset)) {
            ...
            $adEnquiryReportRepository = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:AdEnquiryReport');
            ...
            if (isset($searchParam['search']['csv_name']) && $searchParam['search']['csv_name']) {
                ...
                $fileName = "TiAdEnquiryReport_".date('d-m-Y H:i:s').'.tmp';
            }
    ...
    protected function adEnquiryReportExportToCsv($searchParam, $input, $output)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->getParameter('project_path').'/console fa:ti:export-ad-enquiry-report '.$commandOptions;
        ...
        if (isset($searchParam['search']['csv_email']) && $searchParam['search']['csv_email']) {
            ...
            ->setBody(
                $this->getContainer()->get('templating')->render(
                    'FaTiReportBundle:AdEnquiryReportAdmin:email.html.twig',
    ...
    {
        $qb = CommonManager::getTiHistoryRepository($this->getContainer(), 'FaTiReportBundle:AdEnquiryReport')->getAdEnquiryReportQuery($searchParam['search'], $searchParam['sort'], $this->getContainer(), true);
