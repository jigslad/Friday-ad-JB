...
class UserReportRepository extends EntityRepository
{
    ...
    public function getUserReportQuery($searchParams, $sorter = null)
    {
        ...
        if ($searchParams && !empty($searchParams['rus_from_date'])) {
            ...
            if ($searchParams['rus_date_filter_type'] == 'signup_date') {
                ...
                $qb = $qb->leftJoin('FaTiReportBundle:UserReportDaily', UserReportDailyRepository::ALIAS, 'WITH', UserReportDailyRepository::ALIAS.'.user_id = '.self::ALIAS.'.user_id');
            } else {
                $qb = $qb->where('('.UserReportDailyRepository::ALIAS.'.created_at BETWEEN '.$finalStartDate.' AND  '.$finalEndDate.')');
                $qb = $qb->innerJoin('FaTiReportBundle:UserReportDaily', UserReportDailyRepository::ALIAS, 'WITH', UserReportDailyRepository::ALIAS.'.user_id = '.self::ALIAS.'.user_id');
            }
        }
    ...
    public function getCategoryAndEditionDataArray($searchParams, $container = null)
    {
        ...
        if (CommonManager::inArrayMulti($categoryFields, $searchParams['rus_report_columns'])) {
            $categoryArray = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:UserReportCategoryDaily')->getCategoryInWhichMaxAdPostedByDateRange($searchParams);
        ...
        if (CommonManager::inArrayMulti($editionFields, $searchParams['rus_report_columns'])) {
            $editionArray = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:UserReportEditionDaily')->getEditionInWhichMaxAdPostedByDateRange($searchParams);
        ...
        if (CommonManager::inArrayMulti($packageFields, $searchParams['rus_report_columns'])) {
            if ($dateFilterType == 'signup_date') {
                $packageArray = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:UserReportProfilePackageDaily')->getPackageDetailBySignupDateRange($searchParams);
            } else {
                $packageArray = CommonManager::getTiHistoryRepository($container, 'FaTiReportBundle:UserReportProfilePackageDaily')->getPackageDetailByDateRange($searchParams);
            }
    ...
    public function getPPRReportQuery($searchParams, $sorter = null)
    {
        ...
        if ($searchParams && !empty($searchParams['rus_from_date'])) {
            ...
            $qb = $qb->innerJoin('FaTiReportBundle:UserReportProfilePackageDaily', UserReportProfilePackageDailyRepository::ALIAS, 'WITH', UserReportProfilePackageDailyRepository::ALIAS.'.user_id = '.self::ALIAS.'.user_id');
        }
