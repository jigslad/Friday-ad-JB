 ...
 * @version 1.0
 *
 * @ORM\Table(name="seo_tool_popular_search", indexes={@ORM\Index(name="fa_seo_tool_popular_search_title_index", columns={"title"})})
 * @ORM\Entity(repositoryClass="Fa\Bundle\ContentBundle\Repository\SeoToolPopularSearchRepository")
 * @ORM\EntityListeners({ "Fa\Bundle\ContentBundle\Listener\SeoToolPopularSearchListener" })
 * @ORM\HasLifecycleCallbacks
 */
class SeoToolPopularSearch
{
    /**
     * @var integer
     *
