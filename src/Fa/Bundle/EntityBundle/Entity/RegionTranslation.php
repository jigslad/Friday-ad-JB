...
/**
 * This table is used to store region translation.
 *
 * @author Janaksinh Jadeja <janak@aspl.in>
 * @copyright 2014 Friday Media Group Ltd
 * @version 1.0
 *
 * @ORM\Table(name="region_translation")
 * @ORM\Entity
 */
class RegionTranslation extends AbstractPersonalTranslation
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Fa\Bundle\EntityBundle\Entity\Region", inversedBy="translations")
     * @ORM\JoinColumns({
