...
class CategoryListener
{
    ...
    private function removeCategoryCache($entity)
    {
        ...
        exec('nohup'.' '.$this->container->getParameter('fa.php.path').' '.$this->container->getParameter('project_path').'/console fa:generate:category-slug-path --category_id='.$entity->getId().' >/dev/null &');
        exec('nohup'.' '.$this->container->getParameter('fa.php.path').' '.$this->container->getParameter('project_path').'/console fa:generate:entity-url-keys --category_id='.$entity->getId().' >/dev/null &');
    }
}
