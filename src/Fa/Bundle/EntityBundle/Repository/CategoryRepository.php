...
class CategoryRepository extends NestedTreeRepository
{
    ...
    *
    ...
    public function getFooterCategories($container = null, $locationDetails = array())
    {
        ...
        $query->setHint(\Doctrine\ORM\Query::HINT_CUSTOM_OUTPUT_WALKER, 'Fa\Bundle\EntityBundle\Walker\UseIndexWalker');
    ...
    public function getHeaderCategories($container = null, $locationDetails = array())
    {
        ...
        //$stmt->setHint(Query::HINT_CUSTOM_OUTPUT_WALKER, 'Fa\Bundle\EntityBundle\Walker\UseIndexWalker');
        //$stmt->setHint(UseIndexWalker::HINT_USE_INDEX, 'idx_lft,idx_status');
