...
class LocationRepository extends BaseEntityRepository
{
     ...
     * @return array
     */
    public function getTownsArrayByTerm($term)
    {
        ...
        foreach ($towns as $town) {
            $townArray[] = array('id'=> $town->getId(), 'text' => $town->getName().', '.$town->getParent()->getName());
        }
    ...
    public function getNameBySlug($slug, $lvl = null, $container = null)
    {
        ...
        if ($lvl) {
            $location = $this->findOneBy(array('url' => $slug, 'lvl' => $lvl));
        } else {
    ...
    public function getTownInfoArrayById($location, $container = null, $column = 'id')
    {
        ...
        $townInfoArray = null;
        $town          = $this->findOneBy(array($column => $location, 'lvl' => '3'));
     ...
     * @return array
     */
    public function getCookieValue($location, $container, $slugFlag = false)
    {
        ...
        if ($postCode) {
            ...
            $cookieValue['postcode']       = null;
            $cookieValue['location']       = $cookieValue['county'];
            $cookieValue['paa_county']     = null;
