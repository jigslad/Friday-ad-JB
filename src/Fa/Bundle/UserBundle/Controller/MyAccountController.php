        ...
        if ($this->isAuth() && $request->isXmlHttpRequest()) {
            ...
            if ($paypalEmail && $paypalFirstName && $paypalLastName) {
                ...
                if ($isPaypalVerifiedEmail) {
                    ...
                    $error = $this->get('translator')->trans("<div class='text-center'>This PayPal account is not verified. <div class='image-tooltip-wrapper'><span class='image-tooltip'>Friday-Ad cares about the security of our sellers and buyers. To protect you we ask that you provide details for a verified PayPal account. You can find out more <a href='https://www.paypal.com/uk/smarthelp/article/how-do-i-verify-my-paypal-account-faq444\' target='_blank'>here</a></span><span><a class='error' style='color: #f74d4d;'><u>What does this mean?</u></a></span></div></div>", array(), 'frontend-paypal-email');
                }
            } else {
                $error = $this->get('translator')->trans("<div class='text-center'>This PayPal account is not verified. <div class='image-tooltip-wrapper'><span class='image-tooltip'>Friday-Ad cares about the security of our sellers and buyers. To protect you we ask that you provide details for a verified PayPal account. You can find out more <a href='https://www.paypal.com/uk/smarthelp/article/how-do-i-verify-my-paypal-account-faq444\' target='_blank'>here</a></span><span><a class='error' style='color: #f74d4d;'><u>What does this mean?</u></a></span></div></div>", array(), 'frontend-paypal-email');
            }
