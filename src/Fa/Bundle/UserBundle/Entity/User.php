...
class User implements UserInterface, \Serializable
{
    ...
    public function getProfileName()
    {
        ...
        if ($this->role && ($this->role->getId() == RoleRepository::ROLE_BUSINESS_SELLER_ID || $this->role->getId() == RoleRepository::ROLE_NETSUITE_SUBSCRIPTION_ID) && $this->business_name) {
