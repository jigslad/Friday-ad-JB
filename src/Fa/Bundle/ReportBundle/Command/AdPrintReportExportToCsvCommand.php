...
EOF
    ...
    protected function adPrintReportExportToCsv($searchParam, $input, $output)
    {
        ...
        for ($i = 0; $i < $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->get('kernel')->getRootDir().'/console fa:ad:print:report:export-to-csv '.$commandOptions;
