...
class AdEnquiryReportRepository extends EntityRepository
{
    ...
    public static function getAdEnquiryReportFields($container)
    {
        ...
        $subTableFields  = CommonManager::getHistoryRepository($container, 'FaReportBundle:AdEnquiryReportDaily')->getReportFields();
    ...
    public function getAdEnquiryReportQuery($searchParams, $sorter = null, $container, $isCountQuery = false)
    {
        ...
        $qb = $qb->leftJoin('FaReportBundle:AdEnquiryReportDaily', AdEnquiryReportDailyRepository::ALIAS, 'WITH', AdEnquiryReportDailyRepository::ALIAS.'.ad_id = '.self::ALIAS.'.ad_id');
        if ($searchParams && (in_array('customer_name', $searchParams['report_columns']))) {
            $qb = $qb->leftJoin('FaReportBundle:UserReport', UserReportRepository::ALIAS, 'WITH', UserReportRepository::ALIAS.'.user_id = '.self::ALIAS.'.user_id');
            if (!$isCountQuery) {
