...
class DotmailerFilterAdminController extends CrudController implements ResourceAuthorizationController
{
    ...
    public function approveAction(Request $request, $id)
    {
        ...
        exec('nohup'.' '.$this->container->getParameter('fa.php.path').' '.$this->container->get('kernel')->getRootDir().'/console fa:dotmailer:export-filter --id='.$dotmailerFilter->getId().' >/dev/null &');
