...
/**
 * This command is used to download wightbay feed.
 *
 * php app/console fa:wightbay-ad:download
 *
 * @author Amit Limbadia <amitl@aspl.in>
 * @copyright 2014 Friday Media Group Ltd
 * @version v1.0
 */
class DownloadWightbayAdsAdFeedCommand extends ContainerAwareCommand
{
    /**
     * Configure.
     */
    ...
    {
        $this
        ->setName('fa:wightbay-ad:download')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $feedReader->downloadWightbayFile($type, $modified_since, $site_id);
