...
EOF
    ...
    protected function assignFeedAdPackage($input, $output)
    {
        ...
        for ($i = 40000; $i < $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->get('kernel')->getRootDir().'/console fa:assign:feed-ad-package '.$commandOptions.' '.$input->getArgument('action');
