        ...
        switch ($input->getArgument('action'))
        {
            case 'image':
                ...
                foreach ($files as $file) {
                    ...
                    $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->get('kernel')->getRootDir().'/console fa:feed:parse '.$commandOptions.' '.$input->getArgument('action');
