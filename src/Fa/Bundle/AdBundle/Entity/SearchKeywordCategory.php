...
/**
 * Fa\Bundle\AdBundle\Entity\SearchKeywordCategory
 *
 * This table is used to store processed search keywords with category information.
 *
 * @author Samir Amrutya <samiram@aspl.in>
 * @copyright  2014 Friday Media Group Ltd.
 *
 * @ORM\Table(name="search_keyword_category")
 * @ORM\Entity(repositoryClass="Fa\Bundle\AdBundle\Repository\SearchKeywordCategoryRepository")
...
class SearchKeywordCategory
{
     ...
     * @var integer
     *
     * @ORM\Column(name="search_keyword_id", type="integer", length=10)
     */
