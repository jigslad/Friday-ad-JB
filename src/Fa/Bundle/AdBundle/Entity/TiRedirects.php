 ...
 * @version v1.0
 *
 * @ORM\Table(name="ti_redirects", indexes={@Index(name="fa_redirect_old", columns={"old"})})
 * @ORM\Entity(repositoryClass="Fa\Bundle\AdBundle\Repository\TiRedirectsRepository")
