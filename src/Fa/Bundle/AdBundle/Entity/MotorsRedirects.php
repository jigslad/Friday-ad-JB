 ...
 * @version v1.0
 *
 * @ORM\Table(name="motors_redirects", indexes={@Index(name="fa_redirect_nval", columns={"nval"})})
 * @ORM\Entity(repositoryClass="Fa\Bundle\AdBundle\Repository\MotorsRedirectsRepository")
 * @ORM\HasLifecycleCallbacks
 */
class MotorsRedirects
{
    /**
     * @var integer
     *
