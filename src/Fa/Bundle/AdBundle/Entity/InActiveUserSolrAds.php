...
/**
 * Fa\Bundle\AdBundle\Entity\InActiveUserSolrAds
 *
 * This table is used to store inactive user solr adverts.
 *
 * @author Vijay <vijay.namburi@fridaymediafroup.com>
 * @copyright  2018 Friday Media Group Ltd.
 *
 * @ORM\Table(name="in_active_user_solr_ads", indexes={@ORM\Index(name="fa_ad_id_index", columns={"ad_id"}), @ORM\Index(name="fa_user_id_index", columns={"user_id"}) })
 * @ORM\Entity(repositoryClass="Fa\Bundle\AdBundle\Repository\InActiveUserSolrAdsRepository")
 * @ORM\HasLifecycleCallbacks
 */
class InActiveUserSolrAds
{
