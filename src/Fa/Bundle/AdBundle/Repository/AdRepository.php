...
class AdRepository extends EntityRepository
{
        ...
        try {
            ...
            if ($adUser && $adUser->getPhone() && $adUser->getIsPrivatePhoneNumber()) {
                ...
                if ($ad->getUsePrivacyNumber() && $ad->getPhone()) {
                    exec('nohup'.' '.$container->getParameter('fa.php.path').' bin/console fa:update:ad-yac-number allocate --ad_id='.$ad->getId().' >/dev/null &');
                }
            }
        } catch (\Exception $e) {
    ...
    */
    ...
    public function doAfterAdCloseProcess($adId, $container)
    {
        ...
        //remove yac number
        exec('nohup'.' '.$container->getParameter('fa.php.path').' bin/console fa:update:ad-yac-number setsold --ad_id='.$objAd->getId().' >/dev/null &');
