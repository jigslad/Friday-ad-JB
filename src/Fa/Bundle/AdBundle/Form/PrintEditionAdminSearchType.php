...
/**
 * PrintEditionAdminSearchType form
 *
 * @author Samir Amrutya <samiram@aspl.in>
 * @copyright  2014 Friday Media Group Ltd
 * @version 1.0
 */
class PrintEditionAdminSearchType extends AbstractType
{
    /**
    ...
    {
        $builder
            ->add('print_edition__name', TextType::class)
            ->add(
                'print_edition__status',
                ChoiceType::class,
                array(
            ...
            ->add(
                'print_edition_rule__location_group__id',
                ChoiceType::class,
                array(
    ...
    {
        return 'fa_ad_print_edition_search_admin';
    }
