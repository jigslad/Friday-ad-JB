 ...
 * @version v1.0
 */
class PaaSearchKeywordController extends CoreController
{
    /**
     ...
     */
    public function ajaxGetPaaSearchKeywordsJsonAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            $keywordArray            = array();
            $keywordArray['more']    = false;
            $keywordArray['results'] = $this->getRepository('FaAdBundle:PaaSearchKeywordCategory')->getKeywordsArrayByText($request->get('term'));
