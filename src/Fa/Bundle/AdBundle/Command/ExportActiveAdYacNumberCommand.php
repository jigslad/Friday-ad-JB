...
EOF
    ...
    protected function exportActiveAdYacNumber($input, $output)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->get('kernel')->getRootDir().'/console fa:export:active-ad-yac-number '.$commandOptions.' --verbose';
