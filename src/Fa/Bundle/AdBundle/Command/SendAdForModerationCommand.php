...
EOF
    ...
    protected function sendAdForModeration($searchParam, $input, $output, $isForManualModeration, $manualModerationReason)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->getParameter('project_path').'/console fa:send:ad-for-moderation '.$commandOptions;
