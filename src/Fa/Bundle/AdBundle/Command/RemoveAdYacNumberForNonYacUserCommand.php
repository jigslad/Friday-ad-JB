...
EOF
    ...
    protected function updateNonYacUserAdYacNumber($input, $output)
    {
        ...
        for ($i = 0; $i <= $count;) {
            ...
            $command = $this->getContainer()->getParameter('fa.php.path').$memoryLimit.' '.$this->getContainer()->getParameter('project_path').'/console fa:remove:ad-yac-number-for-non-yac-user '.$commandOptions.' --verbose';
