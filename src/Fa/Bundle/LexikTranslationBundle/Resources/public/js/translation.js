...
app.controller('TranslationCtrl', [
    ...
    function ($scope, $http, $timeout, $location, $anchorScroll, ngTableParams, sharedMessage) {
        ...
        $scope.localeNames = translationCfg.localeNames;
        $scope.editType = translationCfg.inputType;
        $scope.cacheClearGrant = translationCfg.cacheClearGrant;
        $scope.transUpdateGrant = translationCfg.transUpdateGrant;
        $scope.hideColBtnLabel = translationCfg.label.hideCol;
        $scope.tipMsg = translationCfg.label.tipMsg;
        ...
        for (var key in $scope.locales) {
            var columnDef = { title: $scope.localeNames[key], index: $scope.locales[key], edit: (translationCfg.transUpdateGrant ? true : false), filter: {}, sortable: false, visible: true };
