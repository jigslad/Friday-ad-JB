 ...
 * @version 1.0
 */
class UpsellAdminType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add(
                ...
                ChoiceType::class,
                array(
                    'choices' => array_flip(UpsellRepository::getUpsellTypeArray($this->container))
                )
            )
            ->add('upsell_for', HiddenType::class, array('data' => 'ad'))
            ->add('title')
            ->add('description')
            ->add('value')
            ->add('value1')
    ...
    {
        return 'fa_promotion_upsell_admin';
    }
