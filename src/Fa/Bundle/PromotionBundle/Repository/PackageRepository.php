...
class PackageRepository extends EntityRepository
{
     ...
     */
    public function getShopPackageByCategory($category, $currentUserPackage = null, $skipAdminPackages = true)
    {
        $query = $this->createQueryBuilder(self::ALIAS)
     ...
     */
    public function getShopPackageArrayByCategory($category, $skipAdminPackages = true)
    {
        $packages = $this->getShopPackageByCategory($category, null, $skipAdminPackages);
